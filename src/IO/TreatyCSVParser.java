 ...
 * @since 4.13.2015
 */
public class TreatyCSVParser
{

  private String csvLocation = "resources/data/treatyData.csv";
   ...
   *
   */
  public TreatyCSVParser(TreatySelector ts)
  {
    this.ts = ts;
    try
    {
