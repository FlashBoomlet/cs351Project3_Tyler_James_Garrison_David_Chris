 ...
 * @since 5.5.2015
 */
public class RandomEventCSVParser
{

  private String csvLocation = "resources/data/randomEventData.csv";
   ...
   *
   */
  public RandomEventCSVParser(World world)
  {
    this.world = world;
    try
    {
  ...
  private void assignAttributes(String[] atributes)
  {
    ...
    {
      data = new RandomEventData();

      // Assign values
      data.setId(Integer.parseInt(atributes[0]));
      data.setEvent((atributes[1]));
